...
const webProducts = [
  ...
  { id: 3, name: "Web Personal Site", link: "https://omarprogarmmer.github.io/omar-programmer/", description: "This website shows personal works." },
];
...
function showProducts(type) {
  ...
  products.forEach((product, index) => {
    ...
    link.target = "_blank";
    link.textContent = product.link ? "Visit" : "Visit";
